            ...
            <div class="flex justify-between">
                ...
                <div class="pt-4">
                    <a href="{{ route('post.create') }}">
                        <button
                            class="bg-blue-500 text-white px-4 py-2 rounded-md text-1xl font-medium hover:bg-blue-700 transition duration-300">新規追加
                        </button>
                    </a>
                </div>
            </div>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                                            <span
                                                ...
                                                <span aria-hidden="true"
                                                    class="absolute inset-0 bg-green-500 rounded-full"></span>
                                                <span class="relative">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                                            ...
                                            @elseif ($post->publish_flg === 2)
                                                <span
                                                    ...
                                                    <span aria-hidden="true"
                                                        class="absolute inset-0 bg-amber-200 opacity-50 rounded-full">
                                                    </span>
                                                    <span class="relative">
                                                        予約公開
                                                    </span>
